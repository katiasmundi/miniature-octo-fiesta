...
| :----: | :--- | :--- |
| &nbsp;⚠️&nbsp; | Does the registration form (page) include GDPR-compliant consent for processing<br> personal data (e.g., acceptance of the privacy policy)?| Page is empty, but there is a check box to fill when registered |
| &nbsp;⚠️&nbsp; | Can users view, edit, and delete their own personal data via their account? | View: Yes, Edit/Delete: No |
| &nbsp;❌&nbsp; | Is there a mechanism for the administrator to delete a reserver in<br> accordance with the "right to be forgotten"? | No |
...
| &nbsp;⚠️&nbsp; | Is it ensured that names, emails, or other personal data of bookers are not exposed<br> publicly or to unauthorized users? | All logged in users can access api/users  |

--- 

| **Result** | **Access control and authorization** | Comment |
| :----: | :--- | :--- |
| &nbsp;❌&nbsp; | Have you ensured that only administrators can add, modify, and delete<br> resources and bookings? | All logged in users can |
...
| :----: | :--- | :--- |
| &nbsp;⚠️&nbsp; | Has Privacy by Default been implemented (e.g., collecting the minimum data by default)? | Birthday vs. age |
