# ZAP by Checkmarx Scanning Report BookingSystem-Phase2 Kati
...
* URL: http://localhost:8002/login
  ...
  * Evidence: `password`
  * Other Info: `userParam=username
userValue="><script>alert(1)</script>
passwordParam=password
referer=http://localhost:8002/login
csrfToken=csrf_token`
* URL: http://localhost:8002/login
...
* URL: http://localhost:8002/login
  ...
  * Evidence: `password`
  * Other Info: `userParam=username
userValue=test@example.com' OR '1'='1
passwordParam=password
referer=http://localhost:8002/login
csrfToken=csrf_token`
* URL: http://localhost:8002/login
  ...
  * Evidence: `password`
  * Other Info: `userParam=username
userValue=test@example.com' OR pg_sleep(5) --
passwordParam=password
referer=http://localhost:8002/login
csrfToken=csrf_token`
* URL: http://localhost:8002/login
  ...
  * Evidence: `password`
  * Other Info: `userParam=username
userValue=test@test.com' OR pg_sleep(5) --
passwordParam=password
referer=http://localhost:8002/login
csrfToken=csrf_token`
* URL: http://localhost:8002/login
...
* URL: http://localhost:8002/login
  ...
  * Evidence: `password`
  * Other Info: `userParam=username
userValue=username=test@example.com' --
passwordParam=password
referer=http://localhost:8002/login
csrfToken=csrf_token`
* URL: http://localhost:8002/login
  ...
  * Evidence: `password`
  * Other Info: `userParam=username
userValue=username=test@example.com' OR '1'='1
...
* URL: http://localhost:8002/login
  ...
  * Evidence: `password`
  * Other Info: `userParam=username
userValue=username=test@example.com' OR pg_sleep(5) --
passwordParam=password
referer=http://localhost:8002/login
csrfToken=csrf_token`
